---
name: "learn_from_notclicky_logs"
description: "Use when the user asks NotClicky to review logs, find learnings, tune behavior from logs, or create improvements from logged messages."
---
...
# Learn From NotClicky Logs

Use this workflow when the user asks to review logs, learn from logs, tune NotClicky, inspect message JSONL, or turn flagged log comments into improvements.

## Required Inputs

1. Read `NotClickyRuntimeMap.md` from Codex home.
2. Read `memory.md`.
...
- Repeated refusals where NotClicky should have started an agent task.
...
1. Create a timestamped backup under the archives path from `NotClickyRuntimeMap.md`.
