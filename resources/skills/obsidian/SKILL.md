...
NotClicky exposes Obsidian as a local vault path, not as a Composio connector. Use this skill only when the runtime instructions include an Obsidian vault path.
