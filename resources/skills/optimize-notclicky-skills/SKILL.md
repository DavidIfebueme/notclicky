---
name: "optimize_notclicky_skills"
description: "Use when the user asks NotClicky to inspect, audit, improve, consolidate, or optimize bundled or learned skills."
---
...
6. Keep skill names snake_case and action-oriented, for example `create_apple_note` or `review_notclicky_logs`.
