...
[[NotClicky]] is a native macOS companion by [[NotClicky]]. It lives in the menu bar and provides a floating panel, push-to-talk voice input, screen-aware responses, image galleries, local agent work, and a cursor overlay for pointing at UI elements.
